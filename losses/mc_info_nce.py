...
class InfoNCE(nn.Module):
    ...
    def __init__(self, temperature: float = 0.1, normalize: bool = True, uncertainty_weighting: str = ""):
        super().__init__()
    ...
    def forward(self, p1, p2, kappa, t):
        n_batch, _ = p1.shape
        if self.normalize:
...
class MCInfoNCE(nn.Module):
    ...
    def __init__(self, n_samples: int = 16, temperature: int = 0.1, normalize: bool = True, method: str = "simple",
                 uncertainty_weighting: str = "", reduction: str = "mean"):
        super().__init__()
